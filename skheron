#Tools Created By Heron cyber
#Heron Technology Channel
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Heron cyber'
    print '\033[0;94mFACEBOOK : Termux hacker Heron'
    print '\033[0;96mGITHUB   : Hacker Heron'
    print ''
